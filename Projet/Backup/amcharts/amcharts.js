...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    stackGraphs: function (a) {
        ...
        for (k = this.start; k <= this.end; k++)
            for (n = 0; n < h.length; n++) m = h[n], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a ==
    ...
    getMinMax: function () {
        ...
        if (this.includeGuidesInMinMax && 0 < a)
            for (b = 0; b < a; b++) c = this.guides[b], c.toValue <
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function () {
        ...
        var T = [],
            ...
            Na = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == I || "100%" == I || this.fillToGraph) Na = !0;
                    ...
                    if (!isNaN(R)) {
                        ...
                        if (!(R < xb && la < xb || R > yb && la > yb))
                            if (n) {
                                ...
                                if (M < k + $ * z && 0 < K)
                                    if (na = new AmCharts.Cuboid(e, K, ba, z - a.d3x, J - a.d3y, za, Qa, L, ma, this.lineAlpha, ha, r, n, Y, Ra), 0 > R && "middle" != B && "inside" != B) B = "bottom";
                ...
                if (c.mouseIsOver || y || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        ...
                        0 < this.cursorAlpha && (s = this.line, u ? (w = 0, t = r + h) : (w = r, t = 0), A = this.animationDuration, 0 < A && !this.zooming ? isNaN(this.previousX) ?
                            s.translate(w, t) : (s.translate(this.previousX, this.previousY), s.animate({
                                translate: w + "," + t
                                    ...
                                    if (f = J[w], (!this.oneBalloonOnly || f ==
                                        ...
                                        if (this.showNextAvailable && isNaN(s) && a + 1 < this.data.length)
                                            for (r = a + 1; r < this.data.length; r++)
                                                if (q = this.data[r])
                                                    if (v = q.axes[f.valueAxis.id].graphs[f.id], s = v.y, !isNaN(s)) break;
                                        if (!isNaN(s)) {
                                            q = v.x;
                                            t = !0;
                                            if (u) {
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan) this.rolledOver = !1;
                    ...
                    if ("cursor" == this.type) this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d, 2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) :
                        (c.end = this.index, c.start = this.fromIndex), e = a.categoryAxis, e.parseDates && !e.equalSpacing && (c.start = b[c.start].time, c.end = a.getEndTime(b[c.end].time)), this.skipZoomDispatch || this.fire(c.type, c));
                    else {
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var p = [b[m - 1], b[m]], r = [c[m - 1], c[m]], r = AmCharts.makeHD(p, r, a.handDrawScatter), p = r[0], r = r[1], u = 1; u < p.length; u++) n.push(AmCharts.line(a, [p[u - 1], p[u]], [r[u - 1], r[u]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
    ...
    createEntry: function (a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), n = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(n), a.bullet && (a.hidden || (d = a.bulletColorR), n = AmCharts.bullet(k,
